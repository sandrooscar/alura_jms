package br.com.caelum.queue.acknowledge;
...
public class TesteConsumidorAcknowledge {
		...
		consumer.setMessageListener(new MessageListener(){
			...
			public void onMessage(Message message) {
				...
				try {
					...
					//se não der um message.acknowledge(), a mensagem coninuará pendente na fila, e não haverá redelivery
					message.acknowledge();
